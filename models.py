...
class User(UserMixin, db.Model):
    ...
    favorite_restaurants = db.relationship('Restaurant', secondary='user_favorites', back_populates='favorited_by', lazy='dynamic')
...
class Restaurant(db.Model):
    ...
    favorited_by = db.relationship('User', secondary='user_favorites', back_populates='favorite_restaurants', lazy='dynamic')
